Public Class frmMysqlLogin
    ...
    Private Sub frmMysqlLogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If System.IO.File.Exists("CSV Preference Files\Preferences.csv") Then
            NumRows = DanG_EXCEL_Module.CSVFileToArray(PrefArray, "CSV Preference Files\Preferences.csv", TotalFields)
            ...
            ReturnValue = DanG_EXCEL_Module.GetFieldValue_From_Fieldname(PrefArray, 1, "Server_IPv4Addr")

            strHostname = ReturnValue
            strPortNumber = DanG_EXCEL_Module.GetFieldValue_From_Fieldname(PrefArray, 1, "PortNumber")
        Else
