Module ControlsManager
    ...
    Sub InsertOperativeRow(strDeliveryDate As String, strDeliveryRef As String, Optional strASNNo As String = "")
        ...
        For Each frm In Application.OpenForms
            If UCase(frm.Name) = "GI_TIMESHEET" Then
                FindControl = frmMainGIForm.FindFrameControls("GI_TIMESHEET", "Frame_Operatives")
            End If
        Next
        ...
        frmMainGIForm.InsertValueIntoForm("GI_TIMESHEET", "txtTotalOps", CStr(frmMainGIForm.Dic_TotalOperatives(strDeliveryDate & "_" & strDeliveryRef) - 1))
    ...
    Sub SearchAndInsertName(Entry As String, strDeliveryDate As String, strDeliveryRef As String, NumberOfCharsEntered As Integer)
        ...
        If Len(Entry) > 4 Then
            SearchValue = Entry
            FoundName = Module_DanG_MySQL_Tools.Find_myQuery(frmMainGIForm.myConnString, DBEmpoyees, SearchField, SearchValue, "STRING",
            ...
            If FoundName Then
                ...
                StartTimeControl = frmMainGIForm.FindFrameControls("GI_TIMESHEET", SearchControlName)
                If StartTimeControl IsNot Nothing Then
                    ...
                    Call frmMainGIForm.InsertValueIntoForm("GI_TIMESHEET", OpNameField, Fullname)
                    Call frmMainGIForm.InsertValueIntoForm("GI_TIMESHEET", SearchControlName, OpStartTime) 'START TIME FIELD
                    Call frmMainGIForm.InsertValueIntoForm("GI_TIMESHEET", "txtTotalOps", TotalRows)
    ...
    Sub Clear_Entry_Controls(Formname As String, LowerTAG As Long, UpperTAG As Long)
        ...
        For TagNumber = LowerTAG To UpperTAG
            ...
            Clearctrl = frmMainGIForm.FindControls("GI_TIMESHEET", "", TagNumber)
