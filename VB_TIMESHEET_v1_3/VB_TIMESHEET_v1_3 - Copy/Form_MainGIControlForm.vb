Public Class frmMainGIForm
    ...
    Public myVersion As String = "v1.2"
    ...
    Private Sub ShowMainControlToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ShowMainControlToolStripMenuItem.Click
        ...
        cf.Text = "Goods In Control Panel" & CStr(MdiChildren.Count)
        cf.Name = "GI_TIMESHEET"
        cf.Show()
    ...
    Sub ShowForms(FormName As String, Optional Dropdowns() As Object = Nothing, Optional OwnerForm As Form = Nothing)
        ...
        If UCase(FormName) = UCase("GI_TIMESHEET") Then
    ...
    Sub InsertValueIntoForm(FormName As String, ControlName As String, value As String, Optional ByRef comArray As Object = Nothing)
        Dim ctrl As Object
        ...
        If ctrls IsNot Nothing And UBound(ctrls) > -1 Then
            If ctrls(0) Is Nothing Then
                If FoundForm = False Then
                    ...
                    logger.LogError("GI_Error_" & myVersion & ".log", Application.StartupPath, ErrMessage, "GetScreenResolution_Actual()",
    ...
    Function Get_MDIChildForm(TheForm As Form) As Form
        Dim frmName As String

        For Each frm As Form In Application.OpenForms
            If UCase(frm.Name) = UCase(TheForm.Name) Then
        ...
        If TheDatabaseType = "MYSQL" Then
            If myLoggedIn Then
                ...
                If Get_NumericPartOfString(Username) > 0 Then
                    myUsernameSuffix = CStr(Get_NumericPartOfString(Username))
                Else
                    myUsernameSuffix = ""
                End If
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        TimesheetForm = Get_MDIChildForm(frmGI_RP_Userform)

        If Not IsNothing(TimesheetForm) Then
            frmName = TimesheetForm.Name
            If UCase(frmName) = UCase("GI_TIMESHEET") Then
