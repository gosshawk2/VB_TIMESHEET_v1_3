Public Class frmMonthly
    ...
    Private Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        ...
        If UCase(Me.FormTitle) = UCase("alt:Select Delivery Date") Then
            frmMainGIForm.GetDeliveryDate = Me.txtSelectedDate.Text
            Call frmMainGIForm.InsertValueIntoForm("GI_TIMESHEET2", "txtSelectDeliveryDate", frmMainGIForm.GetDeliveryDate)
            'Populate the comDeliveryRef and comASN dropdowns with values from tblDeliveryInfo:
            Populate_DeliveryDateCombo("GI_TIMESHEET2", frmMainGIForm.GetDeliveryDate, "")
            Populate_ASNCombo("GI_TIMESHEET2", frmMainGIForm.GetDeliveryDate, "")
        End If
