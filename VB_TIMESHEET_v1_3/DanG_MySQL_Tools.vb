...
Module Module_DanG_MySQL_Tools
    ...
    Function saveSession(ByVal connString As String, ByVal UserID As String, ByVal Username As String,
        ...
        If Not SessionUpdatedOK Then
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, MyMessage, "saveSession()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End If
    ...
    Function InsertIntoOperatorsTable(connString As String, ByVal strUserID As String, ByVal strUsername As String,
        ...
        If Not IsOpsOnlineUpdatedOK Then
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, MyMessage, "InsertIntoOperatorsTable()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        Else
    ...
    Function GetMyNumFields(connStr As String, Sqlstr As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetMyNumFields()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function GetMyFields(DBTable As String, ByVal myconnString As String, ByRef Message As String, Optional ExcludeFields As String = "",
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetMyFields()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function Get_Field_Index_From_Fieldname(ByVal DBTable As String, ByVal ConnString As String, ByVal Fieldname As String, ByRef ErrorMessage As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, ErrorMessage, "Get_Field_Index_From_Fieldname()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
        ...
        If UCase(frmMainGIForm.DatabaseType) = "ACCDB" Then
            ...
            If Not UserExists Then
                ...
                If Not InsertOK Then
                    ...
                    frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Messages, "SaveToPreferencesTable()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
                    Exit Function
                End If
            Else
    ...
    Function ExportDGVToCSVFile(ByRef dgv As DataGridView, ByVal CSVFilename As String, ByVal Optional Extension As String = ".csv", Optional ByRef anyMessages As String = "") As Boolean
        ...
        If dlgSaveCSV.ShowDialog() = DialogResult.OK Then
            ...
            frmMainGIForm.logger.LogMessage("GI_Error_v1_3.log", Application.StartupPath, "Preference Path:" & CSVPath, frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        Else
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, anyMessages, "ExportDGVToCSVFile()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function ExportDGVToPDFFile(ByRef dgv As DataGridView, ByVal PDFFilename As String, ByVal Optional Extension As String = ".pdf", Optional Widths() As Single = Nothing,
        ...
        If dlgSavePDF.ShowDialog() = DialogResult.OK Then
            ...
            frmMainGIForm.logger.LogMessage("GI_Error_v1_3.log", Application.StartupPath, "Preference Path:" & PDFPath, frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        Else
        ...
        Catch ex As Exception
            anyMessages = "Error in Export " & ex.Message
            'Getting a file is denied error here ???? !!!! - the filename was wrong in the StreamWriter() parameter.
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, anyMessages, "ExportDGVToPDFFile()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function ArrayToCSVFile(ByRef HeaderArr As String(), RowArr As String(), CSVFilename As String, ByVal Optional Extension As String = ".csv",
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "ArrayToCSVFile()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function CSVFileToArray(ByRef NewstrArray As String(,), ByVal CSVFilename As String, Optional ByRef TotalFields As Long = 0,
            ...
            Using csvReader As New Microsoft.VisualBasic.FileIO.TextFieldParser(CSVFilename)
                ...
                While Not csvReader.EndOfData
                    ...
                    Catch ex As Microsoft.VisualBasic.FileIO.MalformedLineException
                        ...
                        Message = messages
                        frmMainGIForm.logger.LogMessage("GI_Error_v1_3.log", Application.StartupPath, Message, frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
                    End Try
                    RowNum = RowNum + 1
                End While
            End Using
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetFieldValue_From_Index()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
        numRowsRead = RowNum
    ...
    Function MySQLToArray(ByVal myConnString As String, ByVal SQLstr As String, ByRef Message As String, Optional ScriptKeyFieldNumber As Long = -1, Optional ByRef dic_TAble As Object = Nothing) As Object
        ...
        If Len(SQLstr) = 0 Then
            ...
            frmMainGIForm.logger.LogError("GI_Error_" & frmMainGIForm.myVersion & ".log", Application.StartupPath, Message, "MySQLToArray()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
            MySQLToArray = Nothing
            Exit Function
        End If
    ...
    Function GetUniqueItemsToSingleArray(ByVal DBTable As String, ByVal myConnString As String, ByVal SQLstr As String, ByVal Fieldname As String, ByRef Message As String) As Object
        ...
        If Len(SQLstr) = 0 Then
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetUniqueItemsToSingleArray()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
            GetUniqueItemsToSingleArray = Nothing
            Exit Function
        End If
        If Len(myConnString) = 0 Then
    ...
    Function ArchiveData(NewTableName As String, OldTableName As String, myConnString As String, SQLstr As String, ByRef ErrMessages As String) As Object
        ...
        If Len(SQLstr) = 0 Then
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, ErrMessages, "MySQLToArray()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
            ArchiveData = Nothing
            Exit Function
        End If
    ...
    Sub PopulateMyDataSource(ByRef DSource As Object, ByVal connString As String, ByRef SQLStr As String,
                             ...
                             Optional ByRef DGV As DataGridView = Nothing,
                             Optional ColumnWidths As String = "")
        Dim con As MySqlConnection
        Dim cmd As MySqlCommand
        ...
        Try
            ...
            If IsDBNull(ds.Tables("srcTable")) Then
                ...
                frmMainGIForm.logger.LogError("GI_Error_" & frmMainGIForm.myVersion & ".log", Application.StartupPath, Message, "PopulateMyDataSource()",
            ...
            Else
                ...
                If NumRows > 0 Then
                    ...
                    If Not IsNothing(DSource) Then
                        ...
                        Next
                        ds.Tables("srcTable").Columns(0).ReadOnly = True
                    End If
                Else
            ...
            If Len(ColumnWidths) > 0 And DGV.ColumnCount > 0 Then
                ColwidthArr = strToStringArray(ColumnWidths, ",", 0, False, False, False, "_", False, 34, 39, NumCols)
                If DGV.ColumnCount < NumCols Then
    ...
    Function Find_myDate(ByVal connString As String, ByVal DBTable As String, ByVal SearchDateFromField As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "Find_myDate()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    End Function
    ...
    Public Function Find_myQuery(ByVal connString As String, ByVal DBTable As String, ByVal SearchField As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "Find_myQuery()", frmMainGIForm.GetComputerName() &
    ...
    Public Function Find_myMultiQuery(ByVal connString As String, ByVal DBTable As String, ByVal SearchField As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "Find_mymultiQuery()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function InsertUpdateMyRecord(ByVal UPDATE As Boolean, ByVal connString As String, DBTable As String,
        ...
        If Len(DBTable) = 0 Then
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, MyMessage, "InsertUpdateMyRecord()",
    ...
    Function DeleteMyRecord(ByVal DBTable As String, ByVal connString As String, ByVal Criteria As String, ByRef MyMessage As String) As Boolean
        ...
        If Len(DBTable) = 0 Then
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, MyMessage, "DeleteMyRecord()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
            DeleteMyRecord = False
            Exit Function
        End If
    ...
    Function PrepareMyInsert(ByVal connString As String, ByVal DBTable As String, ByRef Fieldnames As String, ByVal Fieldvalues As String,
        ...
        Try
            ...
            If Len(DBTable) = 0 Then
                ...
                frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, myMessage, "PrepareMyInsert()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
                PrepareMyInsert = ""
                Exit Function
            End If
            If Len(Fieldnames) = 0 Then
        ...
        Try
            ...
            If UBound(FieldNameArray) > 0 And UBound(ValueArray) > 0 Then
                If UBound(FieldNameArray) < UBound(ValueArray) Then
                    ...
                    frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, myMessage, "PrepareMyUpdate()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
                    PrepareMyUpdate = ""
                    Exit Function
                End If
                If UBound(FieldNameArray) > UBound(ValueArray) Then
    ...
    Function CreateDBUser(ByVal connString As String, ByVal Hostname As String, ByVal Username As String, ByVal Password As String, Optional ByRef MyMessage As String = "") As Boolean
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, MyMessage, "CreateDBUser()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function myPermissions(ByVal DATABASE As String, ByVal connString As String, ByVal Username As String, ByVal Password As String,
        ...
        Catch ex As Exception
            MyMessage = "Exception Error in CreateDBUser: " & ex.ToString
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, MyMessage, "myPermissions()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function GetMYValuebyFieldname(ByVal SearchObjects As Object(), ByVal FieldnamesArr_IN As String(), ByVal ReturnField As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetMYValuebyFieldname()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function GetMyMultiValuebyFieldname(ByVal SearchObjects As Object(,), ByVal Fieldnames As String(), ByVal ReturnField As String,
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetMyMultiValuebyFieldname()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function CheckFieldExists(ByVal SearchField As String, ByVal Fieldlist As String, Optional ByRef Messages As String = "") As Boolean
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Messages, "CheckFieldExists()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function GetMyTotalRows(ByVal connString As String, ByVal DBTable As String, ByRef Message As String) As Long
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Message, "GetMyTotalRows()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
    ...
    Function ReadInPairedDevices_From_CSV_Into_Table(ByVal CSVFilename As String, ByVal DBTable As String, Optional ByRef ErrorMessages As String = "") As Long
        ...
        While RowIdx < UBound(AssetArray, 2)
            ...
            Else
                ...
                frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, Messages, "ReadInPairedDevices_From_CSV_Into_Table()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        ...
        If UCase(frmMainGIForm.DatabaseType) = "ACCDB" Then
            ...
            If Not AssetExists Then
                ...
                If Not InsertOK Then
                    ...
                    frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, ErrMessage, "SaveAssetToTable()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
                    Exit Function
                End If
            Else
                strDateModified = CStr(Now())
    ...
    Function ReturnLastID(DBTable As String, connString As String, ByRef ErrMessage As String) As String
        ...
        Catch ex As Exception
            ...
            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, ErrMessage, "ReturnLastID()", frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() & ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
        End Try
                ...
                If InStr(ParamInfo, "_") > 0 Then
                    ...
                    If Len(ParamInfoArr(2)) > 0 Then
                        ...
                        Else
                            ...
                            frmMainGIForm.logger.LogError("GI_Error_v1_3.log", Application.StartupPath, myMessage, "InsertUpdateRecords_using_Parameters()",
                                        frmMainGIForm.GetComputerName() & "," & frmMainGIForm.GetIPv4Address() & "," & frmMainGIForm.GetIPv6Address() &
                                        ", OPERATOR Logged in:" & frmMainGIForm.myUsername)
                            DontSave = True
                            Continue For
